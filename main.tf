...
module "vpc" {
  ...
  source = "github.com/rany01/terraform-was-vpc.git?ref=v1.0.1"
...
module "eks" {
  source = "github.com/rany01/terraform-aws-eks.git?ref=v1.0.0"
...
module "app" {
  ...
  source = "github.com/rany01/terraform-kubernetes-app.git?ref=v1.0.0"
